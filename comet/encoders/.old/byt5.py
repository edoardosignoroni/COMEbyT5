...
byT5 Encoder
==============
    Pretrained byT5 encoder from Hugging Face.
"""
from typing import Dict, Optional

import torch
from comet.encoders.bymetric5 import ByMeTric5
from transformers import ByT5Tokenizer, T5Config

from comet.encoders.base import Encoder


class ByMeTric5Encoder(Encoder):
    """byT5 encoder.
    ...
    def __init__(
        ...
        if load_pretrained_weights:
            self.model = ByMeTric5.from_pretrained(
                pretrained_model, add_pooling_layer=False
            )
        else:
            self.model = ByMeTric5(
    ...
    def size_separator(self) -> int:
        ...
        E.g: For byT5 is just 1 ([SEP]) but models such as XLM-R use 2 (</s></s>).
    ...
    def uses_token_type_ids(self) -> bool:
        ...
        Returns:
            bool: True for models that use token_type_ids such as byT5.
        """
        return True
